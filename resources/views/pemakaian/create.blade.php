                        ...
                        @if (auth()->user()->role === 'Admin')
                            <div class="card-body">
                                <form action="/admin/transaksi" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" id="pemakaian_sebelum"
                                                ...
                                                placeholder="Pilih Pelanggan Terlebih Dahulu" readonly title="ada">
                                            <span class="input-group-text" id="addon-tanggal-sebelum" title="Tanggal Penginputan Terakhir">Tanggal</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="total_tagihan">Tagihan Bulan ini</label>
                                    ...
                                    <div class="form-group">
                                        <label for="total_hutang">Hutang Sebelumnya</label>
                                        <input type="text" name="total_hutang_readonly" id="total_hutang_readonly"
                                            class="form-control @error('total_hutang') is-invalid @enderror"
                                            value="Rp. {{ number_format(old('total_hutang')) }}" readonly>
                                        <input type="hidden" name="total_hutang" value="{{ old('total_hutang') }}"
                                            id="total_hutang" required>
                                        @error('total_hutang')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
