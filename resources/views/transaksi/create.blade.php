                            ...
                            <form action="/admin/transaksi" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pemakaian_sekarang" id="pemakaian_sekarang"
                                        ...
                                        min="{{ old('pemakaian_sekarang') }}" value="{{ old('pemakaian_sekarang') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="total_tagihan" value="{{ old('total_tagihan') }}" id="total_tagihan" required>
                                    @error('total_tagihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="total_pembayaran" value="{{ old("total_pembayaran") }}" id="total_pembayaran">
